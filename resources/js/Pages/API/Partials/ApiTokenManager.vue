  ...
  <div>
    ...
    <jet-form-section @submitted="createApiToken">
      ...
      <template #form>
        ...
        <div class="col-span-6 sm:col-span-4">
          ...
          <jet-input
            id="name" v-model="createApiTokenForm.name"
            type="text"
    ...
    <jet-dialog-modal :show="managingPermissionsFor" @close="managingPermissionsFor = null">
      ...
      <template #footer>
        ...
        <jet-button
          class="ml-3" :class="{ 'opacity-25': updateApiTokenForm.processing }"
    ...
    <jet-confirmation-modal :show="apiTokenBeingDeleted" @close="apiTokenBeingDeleted = null">
      ...
      <template #footer>
        ...
        <jet-danger-button
          class="ml-3" :class="{ 'opacity-25': deleteApiTokenForm.processing }"
