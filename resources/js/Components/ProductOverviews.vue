        ...
        <ol role="list" class="flex items-center space-x-4">
          <li v-for="breadcrumb in product.breadcrumbs" :key="breadcrumb.id">
            <div class="flex items-center">
              ...
              <svg
                viewBox="0 0 6 20" xmlns="http://www.w3.org/2000/svg"
                aria-hidden="true"
        ...
        <div class="lg:grid lg:grid-cols-12 lg:auto-rows-min lg:gap-x-8">
          ...
          <div class="mt-8 lg:mt-0 lg:col-start-1 lg:col-span-7 lg:row-start-1 lg:row-span-3">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 lg:grid-rows-3 lg:gap-8">
              <img
                ...
                :src="image.imageSrc"
                :alt="image.imageAlt" :class="[image.primary ? 'lg:col-span-2 lg:row-span-2' : 'hidden lg:block', 'rounded-lg']">
            </div>
          </div>
          ...
          <div class="mt-8 lg:col-span-5">
            <form>
              ...
              <button type="submit" class="flex items-center justify-center w-full px-8 py-3 mt-8 text-base font-medium text-white bg-indigo-600 border border-transparent rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                Add to cart
              </button>
            </form>
            ...
            <div class="mt-10">
              ...
              <div class="mt-4 prose-sm prose text-gray-500" v-html="product.description" />
            </div>
            ...
            <section aria-labelledby="policies-heading" class="mt-10">
              ...
              <dl class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2">
                <div v-for="policy in policies" :key="policy.name" class="p-6 text-center border border-gray-200 rounded-lg bg-gray-50">
                  <dt>
                    <component :is="policy.icon" class="flex-shrink-0 w-6 h-6 mx-auto text-gray-400" aria-hidden="true" />
